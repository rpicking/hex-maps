...
public class HexFeatureManager : MonoBehaviour {
    ...
    public Transform[] specialPrefabs;
    ...
    public void AddFeature(HexCell cell, Vector3 position) {
        ...
        Transform otherPrefab = PickPrefab(farmCollections, 
    ...
    /// <summary>
    /// Picks a prefab based on percent change as well as level
    /// </summary>
    ...
    /// <summary>
    /// Create wall along edge between two cells
    ///   Wall created on the nearCell side
    /// </summary>
    ...
    /// <summary>
    /// Create wall on cell corner (between 3 cells)
    /// </summary>
    /// <param name="c1"></param>
    ...
    private void AddWallSegment(
        ...
        if (hasLeftWall) {
            if (hasRightWall) {
                bool hasTower = false;
                // only add tower at same elevation
                if (leftCell.Elevation == rightCell.Elevation) {
                    // hash of center of corner of wall segment
    ...
    /// <summary>
    /// Cap the end of a wall if it isn't a loop
    ///   Used for capping wall gaps for roads and rivers
    /// </summary>
    /// <param name="near"></param>
    /// <param name="far"></param>
    ...
    public void AddSpecialFeature(HexCell cell, Vector3 position) {
        Transform instance = Instantiate(specialPrefabs[cell.SpecialIndex - 1]);
        instance.localPosition = HexMetrics.Perturb(position);
        HexHash hash = HexMetrics.SampleHashGrid(position);
        instance.localRotation = Quaternion.Euler(0f, 360f * hash.e, 0f);
        instance.SetParent(container, false);
