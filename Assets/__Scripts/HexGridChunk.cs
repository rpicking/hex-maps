...
public class HexGridChunk : MonoBehaviour {
    ...
    private void Triangulate(HexCell cell) {
        ...
        // Add feature to center if it has nothing on it
    ...
    private void Triangulate(HexDirection direction, HexCell cell) {
        ...
        if (cell.HasRiver) {
            ...
            // add feature to direction if that direction has nothing 
    ...
    private void TriangulateConnection(
        ...
        // allow feature manager to build/decided of wall should be built
    ...
    private void TriangulateCorner(
        ...
        // allow feature manager to create wall corner
